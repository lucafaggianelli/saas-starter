...
CREATE TABLE "Project" (
    "id" SERIAL NOT NULL,
    "name" TEXT NOT NULL,
    "orgenizationId" INTEGER NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- AddForeignKey
ALTER TABLE "Project" ADD CONSTRAINT "Project_orgenizationId_fkey" FOREIGN KEY ("orgenizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
